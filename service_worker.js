(() => {
  const e = "https://www.meetenhancementsuite.com/",
    o = `${e}signup`,
    t = `${e}goodbye`,
    a = [
      "addChimes",
  ...
  (a.keyCode = {
    ...
    (a.adjustVolume = "10"),
    (a.borderColor = "#64ffda"),
    chrome.runtime.onInstalled.addListener((e) => {
      "install" === e.reason &&
        (chrome.tabs.create({ url: o }), chrome.storage.sync.set(a));
    }),
    chrome.runtime.setUninstallURL(t),
    chrome.runtime.onMessage.addListener((e, o, t) => {
      "popupOpen" === e && (chrome.action.setBadgeText({ text: "" }), t(!0));
    });
})();
