(() => {
    ...
    chrome.storage.sync.get("licenseKey", (e) => {
      if (!1 === e.licenseKey) {
        ...
        (document.querySelector(".oORaUb").style.boxShadow = "none"),
          ...
          document.getElementById("upsellDismiss").addEventListener("click", V),
          (n.style.cssText =
  ...
  function z(e) {
    if (e)
      s = setInterval(() => {
        ...
        e && e.click(),
          n && n.childNodes[1] && (n.childNodes[1].remove(), clearInterval(s));
      }, 100);
    else {
      clearInterval(s);
          ...
          (c = setInterval(() => {
            ...
            if (n && !n.getAttribute("mesAlreadyTranscribed")) {
              n.getAttribute("mesMainMenuClicked") ||
                (n.click(),
                n.setAttribute("mesMainMenuClicked", "true"),
                console.log("OPENED MENU ACTIVITES MENU"));
              const e = document.querySelector('[jsname="QGvzrd"]');
              if (!e) return;
              ...
              if (!t) {
                ...
                return (
                  e && (e.click(), console.log("CLOSE SIDEBAR")),
                  clearInterval(c),
                  void setTimeout(() => {
                    alert(
              ...
              t &&
                ...
                (ke(t),
                t.setAttribute("mesTransClicked", "true"),
                console.log("CLICK TRANSCRIBE BUTTON"));
              ...
              r &&
                ...
                (ke(r),
                r.setAttribute("mesTransStartClick", "true"),
              ...
              i &&
                ...
                (ke(i),
                r.setAttribute("mesModelStartClick", "true"),
                console.log("CLICK MODAL AGREE"));
              const l = document.querySelector('button[jscontroller="soHxf"]');
              l && (l.click(), console.log("CLOSE SIDEBAR")),
                n.setAttribute("mesAlreadyTranscribed", "true"),
                console.log("SET ALREADY TRANSCRIBED");
            }
            const t = document.querySelector('[jscontroller="JZWtHb"] #c3');
            t &&
              t.textContent &&
              t.textContent.includes("This call is being transcribed") &&
      ...
      ? (document
        ...
        (l = setInterval(() => {
          let e = document.querySelector('[jscontroller="HVHelf"]'),
            ...
            o = document.querySelector('[jscontroller="ywOR5c"][jsowner]'),
            r = document.querySelector('[jsname="wcuPXe"]'),
            a = document.querySelector('[jsname="ME4pNd"]'),
            i = document.querySelector('[jsname="A0ONe"'),
            c = document.querySelector('[jscontroller="ZakeSe"'),
            s = document.querySelector(".VfPpkd-T0kwCb");
          if (e.firstChild)
            (document.getElementById("recordBlock").style.display = "none"),
              clearInterval(l);
          else {
            t &&
              !t.getAttribute("mesClicked") &&
              (t.click(),
              t.setAttribute("mesClicked", "true"),
              setTimeout(() => {
                document.getElementById("recordBlock").style.display = "none";
              }, 1500)),
              r &&
                !r.getAttribute("mesClicked") &&
                (ke(r), r.setAttribute("mesClicked", "true"));
            ...
            if (n && e.length) {
              const n = e[e.length - 1],
                t = n.parentElement,
                o = n.querySelector('input[jsname="YPqjbf"]'),
            ...
            if (
              (i &&
                ...
                (ke(i), i.setAttribute("mesClicked", "true")),
              c)
            ) {
              s.children[1].click(),
                a.classList.add("qdulke"),
                clearInterval(l);
            }
            o &&
              !r &&
          ...
          if (e.firstChild)
            ...
            if (n && e.length) {
              ...
              r &&
                ...
                o &&
                !1 === o.checked &&
                (console.log("check box triggering"), ke(r)),
                console.log("manual record ready"),
                clearInterval(l);
            }
            o &&
              !r &&
  ...
  function re(e) {
    e
      ? (h = setInterval(() => {
          (E = document.querySelectorAll("[data-self-name]")),
  ...
  function de(e) {
    e
      ? (j.interval = setInterval(() => {
          const e = document.querySelector(".z1gyye.bGuvKd");
          e
            ? ((j.isPresenting = !0), (j.curPresenter = e.textContent))
            : ((document.fullscreenElement ||
                document.webkitFullscreenElement ||
                document.mozFullScreenElement) &&
                !0 === j.enabledFullScreen &&
            ...
            j.isPresenting &&
              "You are presenting" !== j.curPresenter &&
              (j.enabledFullScreen ||
                ((j.enabledFullScreen = !0),
  ...
  function Be() {
    setInterval(() => {
      ...
      e &&
        ...
        document.getElementById("muteAllButton").addEventListener("click", Ie));
    }, 500);
  }
  function Ie() {
  ...
  function je() {
    ...
    (e.scrollTop = e.scrollHeight),
      ...
      0 == A.length && A.push([[window.location.href]]);
    var n = document.querySelectorAll(".zWGUib");
    A.push([["Attendence Taken on " + Date()]]),
      n.forEach((e) => {
        (newAttendee = [[e.textContent]]), A.push(newAttendee);
      }),
              ...
              if (
                ...
                t &&
                  ...
                  e.hideJoinUpsell
                    ...
                    : N(),
                  e.muteMicrophone && be(e.muteMicrophone),
                  e.muteVideo && he(e.muteVideo),
                  e.autoJoin &&
            ...
            t = setInterval(() => {
              if (
                ...
                e.licenseKey &&
                  ...
                  e.minimizeVideo && z(e.minimizeVideo),
                  e.autoRecord && O(e.autoRecord, e.autoTranscribe),
                  e.autoTranscribe &&
                    K(e.autoTranscribe, e.autoRecord || e.manualRecord),
                  e.manualRecord &&
                    !e.autoRecord &&
                    G(e.manualRecord, e.autoTranscribe),
                  e.hideTopBar && Z(e.hideTopBar),
                  e.autoCopyURL && _(e.autoCopyURL),
                  e.speakerBorder && X(e.speakerBorder),
                  e.autoUnmute && $(e.autoUnmute),
                  e.pictureInPicture && ee(e.pictureInPicture),
                  e.autoAdmit && ge(e.autoAdmit),
                  e.autoReject && ye(e.autoReject),
                  e.noAddOthers && ve(e.noAddOthers),
                  e.mirrorVideos && le(e.mirrorVideos),
                  e.autoChat && pe(e.autoChat),
                  e.displayClock && fe(e.displayClock),
                  e.autoFullScreen && de(e.autoFullScreen),
                  e.mutePopup && se(e.mutePopup),
                  e.hideCommentBubble && Se(e.hideCommentBubble),
                  e.hideComments && Ce(e.hideComments),
                  e.transBar && qe(e.transBar)),
                e.ignorePresentationModal && R(e.ignorePresentationModal),
                e.muteMicrophone && be(e.muteMicrophone),
                e.muteVideo && he(e.muteVideo),
                e.addChimes && F(e.addChimes),
                ...
                e.hideToolsUpsell
                  ? e.hideToolsUpsell &&
                    chrome.storage.sync.get("hideToolsUpsellDate", (e) => {
                      new Date().getTime() >
                        new Date(e.hideToolsUpsellDate).getTime() && H();
                    })
                  : H(),
                e.leavePrompt && te(e.leavePrompt),
                e.autoCaptions && me(e.autoCaptions),
                e.hideNames && re(e.hideNames),
                e.showNames && oe(e.showNames),
                e.hideTalkIcons && ae(e.hideTalkIcons),
                e.meetingTimer && ie(e.meetingTimer),
                e.pinBottomBar && ce(e.pinBottomBar),
      ...
      (function (e) {
        for (let n in e) {
          ...
          if (document.querySelector("c-wiz")) {
            if (
              ("ignorePresentationModal" === n && R(t.newValue),
              "autoRecord" === n && O(t.newValue, e.autoTranscribe.newValue),
              "autoTranscribe" === n &&
                K(t.newValue, e.autoRecord.newValue || e.manualRecord.newValue),
              "manualRecord" === n && G(t.newValue, e.autoTranscribe.newValue),
              "addChimes" === n && F(t.newValue),
              "setBackgroundColor" === n && Y(t.newValue),
              "hideTopBar" === n && Z(t.newValue),
              "speakerBorder" === n && X(t.newValue),
              "autoUnmute" === n && $(t.newValue),
              "pictureInPicture" === n && ee(t.newValue),
              "meetingTimer" === n && ie(t.newValue),
              "toggleBottomBar" === n && ne(t.newValue),
              "pinBottomBar" === n && ce(t.newValue),
              "hideNames" === n && re(t.newValue),
              "showNames" === n && oe(t.newValue),
              "hideTalkIcons" === n && ae(t.newValue),
              "muteMicrophone" === n && be(t.newValue),
              "muteVideo" === n && he(t.newValue),
              "leavePrompt" === n && te(t.newValue),
              "mirrorVideos" === n && le(t.newValue),
              "autoJoin" === n)
            ) {
              const e = setInterval(() => {
            ...
            if (
              ("licenseKey" === n && !1 !== t.newValue && (Be(), we()),
              "minimizeVideo" === n && z(t.newValue),
              "autoCopyURL" === n && _(t.newValue),
              "autoAdmit" === n && ge(t.newValue),
              "autoReject" === n && ye(t.newValue),
              "noAddOthers" === n && ve(t.newValue),
              "autoChat" === n && pe(t.newValue),
              "displayClock" === n && fe(t.newValue),
              "darkMode" === n && Ee(t.newValue),
              "autoFullScreen" === n && de(t.newValue),
              "mutePopup" === n && se(t.newValue),
              "hideCommentBubble" === n && Se(t.newValue),
              "hideComments" === n && Ce(t.newValue),
              "transBar" === n && qe(t.newValue),
              "autoCaptions" === n && me(t.newValue),
              "quickLeave" === n &&
                (t.newValue
              ...
              "smartUnmute" === n &&
                (t.newValue
                  ...
                  : (document.body.removeEventListener("keydown", Le),
                    document.body.removeEventListener("keyup", Ve))),
              "keyCode" === n)
            ) {
              Ue(new He(t.newValue));
            }
            "backgroundColor" === n && W(t.newValue),
              "borderColor" === n && Q(t.newValue),
              "adjustVolume" === n && J(t.newValue);
          }
        }
      })(e)
    );
  ...
  function Ue(e) {
    Pe &&
      ...
      (Le = De(e, "true")),
      (Ve = De(e, "false")),
      document.body.addEventListener("keydown", Le),
